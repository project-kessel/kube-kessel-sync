...
// +kubebuilder:rbac:groups=kessel.project-kessel.org,resources=syncconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kessel.project-kessel.org,resources=syncconfigs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=kessel.project-kessel.org,resources=syncconfigs/finalizers,verbs=update
